...
CREATE TABLE `uim_menu`  (
  ...
  `menu_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '菜单名',
  ...
  `visible` int NULL DEFAULT 0 COMMENT '权限状态 0显示 1隐藏',
