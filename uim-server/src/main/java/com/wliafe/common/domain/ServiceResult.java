...
public class ServiceResult extends HashMap<String, Object> {
    ...
    /**
     * 初始化一个新创建的 ServiceResult 对象，使其表示一个空消息。
     */
    public ServiceResult() {
    }

    /**
     * 初始化一个新创建的 ServiceResult 对象
     *
     * @param code 状态码
     * @param msg  返回内容
     */
    ...
    public static ServiceResult success(Object data) {
        return ServiceResult.success("操作成功", data);
    }
    ...
    public static ServiceResult success(String msg) {
        return ServiceResult.success(msg, null);
    }
    ...
    public static ServiceResult success(String msg, Object data) {
        return new ServiceResult(HttpStatus.SUCCESS, msg, data);
    }
    ...
    public static ServiceResult error(String msg) {
        return ServiceResult.error(msg, null);
    }
    ...
    public static ServiceResult error(String msg, Object data) {
        return new ServiceResult(HttpStatus.ERROR, msg, data);
    }
